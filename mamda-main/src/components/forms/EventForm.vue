...
<template>
  <VCard width="640px">
    <VToolbar tag="div" color="transparent">
      <VToolbarTitle>Je Fixe Un Rendez-Vous</VToolbarTitle>
    ...
    <VCardText>
      <VForm>
        <VRow class="d-flex mb-3">
          ...
          <VCol cols="12">
            <VLabel class="mb-1">Rendez-Vous Pour</VLabel>
            <VSelect
          ...
          <VCol cols="12">
            <VLabel class="mb-1">Sujet</VLabel>
            <VSelect
              v-model="formModel.extendedProps.calendar"
              :items="eventStore.availableCalendars"
              item-title="label"
          ...
          <VCol cols="12">
            <VLabel class="mb-1">Type De Rendez-Vous</VLabel>
            <VSelect
              v-model="formModel.extendedProps.calendar"
              :items="eventStore.availableCalendars"
              item-title="label"
          ...
          <VCol cols="12">
            <VLabel class="mb-1">La Date</VLabel>
          ...
          <VCol cols="12">
            <VLabel class="mb-1">L'adress Du Rendez-Vous</VLabel>
    ...
    <div class="d-flex justify-end pa-3">
      <VBtn @click="handleCancel" variant="plain">Annuler</VBtn>
      <VBtn color="primary" @click="handleSubmit" :loading="submiting">Sauvegarder</VBtn>
    </div>
  </VCard>
</template>
