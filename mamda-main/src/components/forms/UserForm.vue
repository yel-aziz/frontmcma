...
<template>
  <VCard width="640px">
    <VToolbar tag="div">
      <VToolbarTitle>Cloturer</VToolbarTitle>
    ...
    <VCardActions>
      <VBtn type="submit" variant="outlined" color="primary" @click="handleSubmit">Enregitrer</VBtn>
      <VBtn @click="handleCancel">Annuler</VBtn>
    </VCardActions>
  </VCard>
</template>
@/store/userStore
